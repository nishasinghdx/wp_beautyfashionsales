...
$options[] = array(
	'name' => __('Contact_Us_Map', 'options_check'),
	'desc' => __('here we add the link of the google map', 'options_check'),
	'id' => 'map_textarea',
	'std' => 'Default Text',
	'type' => 'textarea');
			...
			$options[] = array(
				...
				$options[] = array(
					...
					$options[] = array(
						...
						$options[] = array(
							'name' => __('Contact_Us_Opening_Hours', 'options_check'),
							'desc' => __('here we add the timing of opening hours', 'options_check'),
							'id' => 'openinghours_textarea',
							'std' => 'Default Text',
							'type' => 'textarea');
							...
							$options[] = array(
								...
								$options[] = array(
									...
									$options[] = array(
										...
										'type' => 'text');
										$options[] = array(
											'name' => __('Social_Icon_Instagram', 'options_check'),
											'desc' => __('here we add the link of Instagram', 'options_check'),
											'id' => 'instagram_text',
											'std' => 'Default Value',
											'type' => 'text');
